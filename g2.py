...
option = st.sidebar.radio(
    'Select an option:', 
    ['', 'Plot Stock Data by Promoter', 'Plot Summary Statistics'], 
    index=0  
)
...
df = pd.read_csv("/home/micro2/Documents/ana1/try1.csv")
...
if option == 'top Promoters':
    ti = st.number_input("Top", min_value=1, max_value=100, step=1)
